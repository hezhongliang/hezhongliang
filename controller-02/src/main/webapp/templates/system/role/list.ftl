...
<body class="gray-bg">
			...
			<div class="ibox">
				<div class="ibox-body">
					<div id="exampleToolbar" role="group">
						...
						<@shiro.hasPermission name="sys:role:batchRemove">
                        <button shiro:hasPermission="sys:role:batchRemove" type="button"
                                class="btn btn-danger" onclick="daochu()">
	...
	<div th:include="include::footer"></div>
	 <#include "../../footer.ftl">
	<#--<script type="text/javascript" src="${base}/static/js/appjs/sys/role/role.js">-->
	<script>
                                ...
                                columns : [
                                    ...
                                    },
                                    {
                                        ...
                                        formatter : function(value, row, index) {
                                            var e = '<@shiro.hasPermission name="sys:role:edit"><a class="btn btn-primary btn-sm '+s_edit_h+'" href="#" mce_href="#" title="编辑" onclick="edit(\''
                                                    + row.roleId
                                                    + '\')"><i class="fa fa-edit"></i></a> </@shiro.hasPermission>';
                                            var d = '<@shiro.hasPermission name="sys:role:remove"><a class="btn btn-warning btn-sm '+s_remove_h+'" href="#" title="删除"  mce_href="#" onclick="remove(\''
                                                    + row.roleId
...
<script>
	...
	function daochu(){
	    	...
	    	location.href="${base}/role/exportexcel";
	}
</script>
</body>
