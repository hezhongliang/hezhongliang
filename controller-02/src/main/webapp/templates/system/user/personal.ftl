            ...
            <div class="ibox">
                ...
                <div class="tab-content">
                   ...
                   <#list sexList as item>
                    ...
                    <#if item.id == user.sex>
                        <#if user.sex==96>
         <input  field="*{item.sex}" type="radio" name="sex" checked value="${item.id}"/>男
        <input  field="*{item.sex}" type="radio" name="sex" value="97"/>女
                        <#elseif user.sex==97>
        <input  field="*{item.sex}" type="radio" name="sex" value="96" />男
        <input  field="*{item.sex}" type="radio" name="sex" value="${item.id}" checked/>女
                        </#if>
                    </#if>
                   </#list>
                                </div>
                           ...
                           <div class="gg-formGroup">
                                ...
                                <div class="gg-formDetail">
                                    <input type="text" class="laydate-icon layer-date form-control" id="birth" name="birth" value="${user.birth}" placeholder="请选择出生年月"
                    ...
                    <div class="ibox-content tab-pane fade gg" id="photo_info">
                        <div class="ggcontainer" id="crop-avatar">
                            <form class="avatar-form" action="${base}/user/uploadImg" enctype="multipart/form-data" method="post">
                    ...
                    <div class="ibox-content tab-pane fade" id="pwd_info">
                        ...
                        <div class="gg-btnGroup">
                            <button type="button" class="btn btn-sm btn-primary" id="pwd_save1" onclick="upPwd()">保存</button>
                        </div>
                    </div>
...
<#include "../../footer.ftl">
<script type="text/javascript" src="${base}/static/js/appjs/sys/user/personal.js"></script>


<script type="text/javascript">
    /* var pwd123 = ${pwd};
     var pwds123 = $("#pwdOld").val();
     if (pwd123 == pwds123) {
         alert(1111)
     }*/
     // $("#pwd_save1").click(
    function upPwd() {
        if ($("#pwdOld").val()==${user.password}) {
            upPwd1();
        }else{
            alert("旧密码不对")
        }
