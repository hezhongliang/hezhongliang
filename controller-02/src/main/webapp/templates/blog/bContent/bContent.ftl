...
<script>
                ...
                .bootstrapTable(
                        {
                            ...
                            url :"${base}/blog/queryblog.do", // 服务器数据的加载地址
                            // showRefresh : true,
                            // showToggle : true,
                            showColumns : true,
                            iconSize : 'outline',
    ...
    function add() {
        var addPage = layer.open({
            ...
            area : [ '800px', '520px' ],
            content :"${base}/blog/toadd.do" // iframe的url
        });
        layer.full(addPage);
    }
    function edit(cid) {
        var editPage = layer.open({
            ...
            shadeClose : false, // 点击遮罩关闭层
            area : [ '800px', '520px' ],
            content : "${base}/blog/queryhui?cid=" + cid // iframe的url
        });
        layer.full(editPage);
    }
    function remove(id) {
    ...
    function preview(id) {
        window.open("${base}/blog/open/post/"+id);
